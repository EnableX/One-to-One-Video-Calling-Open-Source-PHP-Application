...
* Clone or download this repository `git clone --recurse-submodules https://github.com/EnableX/One-to-One-Video-Calling-Open-Source-PHP-Application.git`
...
Before you you try accessing the /client folder using browser,

* Configure the API Service by editing `api/config.php` file to use your app ID and app key
...
* Configure your application URL by editing `config.js` file
